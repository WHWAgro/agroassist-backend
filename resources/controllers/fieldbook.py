...
class FieldBookApi(Resource):
  ...
  "2": [
    "AGRICOLA LOS ARANDANOS DE JUNQU",
    "AGRICOLA LOS BRONCES DE CAUQUEN",
    "FUNDO LOS ZORRILLOS DE TONLEMU",
    "Fundo San José",
    "Fundo San Gabriel",
    "FUNDO ALTO LOS OLMOS",
    "Fundo El Patagual",
    "Fundo La Perla",
    "Fundo CunCun",
  ...
  "5": [
    "Rodrigo Fuentes",
    "RESTO RETAZO PARCELA 34",
    "Cristobal Rivera Verdugo",
    "PARCELA 30 LOTE 2",
    "JOSÉ BERNARDO LEÓN PIÑA",
    "MARIA LORETO URCELAY JIMENEZ",
    "PC 10 LA UNION",
    "PARCELA 22",
    "COLCHAMAULE",
    "EL CARMEN",
